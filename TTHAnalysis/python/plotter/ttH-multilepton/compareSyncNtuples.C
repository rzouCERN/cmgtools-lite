...
void compareSyncNtuples()
{
  ...
  std::string inputFilePath_ref = "/home/ucl/cp3/elfaham/CMSSW_9_4_4/src/CMGTools/TTHAnalysis/python/plotter";
  std::string inputFileName_ref = "2016_v6.root";
  ...
  std::string legendEntry_ref = "VUB, v6";
  std::string selection_ref = "n_presel_jet >= 1";

  std::string inputFilePath_test = "/home/ucl/cp3/elfaham/CMSSW_9_4_4/src/CMGTools/TTHAnalysis/python/plotter";
  ...
  std::string inputFileName_test = "syncTree_2016_TTH.root"; std::string legendEntry_test = "Louvain, v1";
  ...
  std::string outputFilePath = "/home/ucl/cp3/elfaham/plots_syncNtuple_94X_VUB6_Louvain1";
